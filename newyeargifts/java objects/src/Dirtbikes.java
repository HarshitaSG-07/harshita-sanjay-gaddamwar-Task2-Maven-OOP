...
class bmodel implements model{
	...
	{
		System.out.println("\n");
		System.out.println("The Bike's Model is : V Rod muscle\n");
	}
}
//ABSTRACT CLASSES
abstract class Name { 
    final void print() { 
    	System.out.println("The bike's brand is : Harley Davidson"); } 
} 
...
public class Dirtbikes{
	...
	public static void main(String[] args) {
		...
		{
			System.out.println("\n");
			System.out.println("The bike is available in USA");
		}
		else
		{
			System.out.println("\n");
			System.out.println("The bike is not available in " +db.getname()+" but you can import it from USA");
		}
